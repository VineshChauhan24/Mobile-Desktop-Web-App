 ...
 * @description: This test script verifies the sharing playlist through email by
 *               entering valid email address in from and to fields.
 * @Created on 12-May-2016 Last updated on 17-May-2016
 * 
 */

public class VerifyEmaiSharingPlaylistSend extends BaseTest {
	...
	/**
	 * Enter valid email address in From and To email fields and click on Send
	 * button
	 */
	@Test(description = "Step 6: Enter valid email address in From and To email fields and click on Send button.", priority = 6)
	public void Step06_VerifyPlaylistEmailSend() throws Exception {
