 ...
 * @description: This test script verifies the validations in email sharing
 *               pop-up window by entering invalid or blank email address in
 *               from and to fields.
 * @Created on 17-May-2016 Last updated on 17-May-2016
 * 
 */

public class VerifyEmailValidationsInEmailSharingPopUp extends BaseTest {
	...
	/**
	 * Keep From and To email fields blank and click on Send button
	 * 
	 */
	@Test(description = "Step 6: Keep From and To email fields blank and click on Send button.", priority = 6)
	public void Step06_VerifyErrorMsgKeepingFromToEmailsBlank()
			throws Exception {

		// Click on send button by keeping to and from email id blank
		HomeFun.clickOnSendButton();

		// Verify error message displayed for from email

		Assert.assertTrue(CustomFun.isElementPresent(By.xpath(ObjRepoProp
				.getProperty("emailSharePopUpFromEmailError_XPATH")), driver),
				"Error message is not displayed for from email id when it is blank.");

		log.info("The Error message '"
				+ driver.findElement(
						By.xpath(ObjRepoProp
								.getProperty("emailSharePopUpFromEmailError_XPATH")))
						.getText()
				+ "' is displayed for from email id when it is blank.\n");
		Reporter.log("<p>The Error message '"
				+ driver.findElement(
						By.xpath(ObjRepoProp
								.getProperty("emailSharePopUpFromEmailError_XPATH")))
						.getText()
		...
		// Verify error message displayed for to email

		Assert.assertTrue(CustomFun.isElementPresent(By.xpath(ObjRepoProp
				.getProperty("emailSharePopUpToEmailError_XPATH")), driver),
				"Error message is not displayed for to email id when it is blank.");

		log.info("The Error message '"
				+ driver.findElement(
						By.xpath(ObjRepoProp
								.getProperty("emailSharePopUpToEmailError_XPATH")))
						.getText()
				+ "' is displayed for to email id when it is blank.\n");
		Reporter.log("<p>The Error message '"
				+ driver.findElement(
						By.xpath(ObjRepoProp
								.getProperty("emailSharePopUpToEmailError_XPATH")))
	...
	/**
	 * Enter invalid email address in From and To email fields and click on Send
	 * button
	 * 
	 */
	@Test(description = "Step 7: Enter invalid email address in From and To email fields and click on Send button.", priority = 7)
	public void Step07_VerifyErrorMsgInvalidFromToEmailsBlank()
			throws Exception {

		String fromEmail = TextProp.getProperty("invalidemail");
		String toEmail = TextProp.getProperty("invalidemail");
		...
		Assert.assertTrue(CustomFun.isElementPresent(By.xpath(ObjRepoProp
				.getProperty("emailSharePopUpFromEmailError_XPATH")), driver),
				"Error message is not displayed for from email id when it is invalid.");
		...
		log.info("The Error message '"
				+ driver.findElement(
						By.xpath(ObjRepoProp
								.getProperty("emailSharePopUpFromEmailError_XPATH")))
						.getText()
				+ "' is displayed for from email id when it is invalid.\n");
		Reporter.log("<p>The Error message '"
				+ driver.findElement(
						By.xpath(ObjRepoProp
								.getProperty("emailSharePopUpFromEmailError_XPATH")))
		...
		Assert.assertTrue(CustomFun.isElementPresent(By.xpath(ObjRepoProp
				.getProperty("emailSharePopUpToEmailError_XPATH")), driver),
				"Error message is not displayed for to email id when it is invalid.");
		...
		log.info("The Error message '"
				+ driver.findElement(
						By.xpath(ObjRepoProp
								.getProperty("emailSharePopUpToEmailError_XPATH")))
						.getText()
				+ "' is displayed for to email id when it is invalid.\n");
		Reporter.log("<p>The Error message '"
				+ driver.findElement(
						By.xpath(ObjRepoProp
								.getProperty("emailSharePopUpToEmailError_XPATH")))
