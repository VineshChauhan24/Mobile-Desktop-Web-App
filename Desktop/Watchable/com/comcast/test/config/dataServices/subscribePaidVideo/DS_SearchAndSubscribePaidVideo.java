...
/**
 * Class Name: DS_SeachAndSubscribePaidVideo Description: This Data service is
 * to subscribe paid video by logging registered user into Comcast application.
 * 
...
public class DS_SearchAndSubscribePaidVideo extends BaseTest {
	...
	@Test
	public void testSearchVideoSubscriptionFeedback(WebDriver driver)
			throws Exception {
		...
		userLogin.ChangePassword(driver, DataServiceProperties._PASSWORD,
		...
		driver.findElement(By.name("pin_code")).clear();
		driver.findElement(By.name("pin_code")).sendKeys(
				DataServiceProperties._CC_PIN_CODE);
