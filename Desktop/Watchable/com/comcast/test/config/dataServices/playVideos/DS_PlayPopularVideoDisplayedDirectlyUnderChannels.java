...
/**
 * Class Name: DS_PlayPopularVideoDisplayedDirectlyUnderChannels Description:
 * This data service play's Popular Channels video which contains directly under
...
public class DS_PlayPopularVideoDisplayedDirectlyUnderChannels extends BaseTest {
	...
	@Test
	public void testDS_PlayPopularVideoDisplayedDirectlyUnderChannels()
			throws Exception {
					...
					String videoResponse = RestAPIServices
							.getSessionTokenResponse(
									UrlFactoryUtil.getInstance()
											.getVideoDetailsURL(channelId, 10),
									sessionToken);
