...
/**
 * Class Name: VerifyNavigatingToVideoPageClickingOnGenreButtonFromPlayList
 * Description: This test script verifies navigating video page after clicking
 * on genre button from play list. list. Author: Manoj
 * **/

public class VerifyNavigatingToVideoPageClickingOnGenreButtonFromPlayList
		extends BaseTest {
	AssertionRepoFunctions assertionFunction = new AssertionRepoFunctions();

	@Test
	public void testVerifyNavigatingToVideoPageClickingOnGenreButtonFromPlayList()
			throws Exception {

		try {

			log.info("Script: VerifyNavigatingToVideoPageClickingOnGenreButtonFromPlayList");
			log.info("******************************************************************");
			...
			if (playListCount > 0) {
				...
				// Verify genre button in Play List
				assertTrue(
				...
				PlayListsFun.clickOnGenreButtonFromPlayList();
