...
/**
 * Class Name: VerifyPlayListSharingSendWithBlankFields Description: This test
 * script verifies clicking on send button from play list sharing pop up window
 * by keeping all fields blank, displaying error message for each fields.
 * Author: Manoj
 * **/

public class VerifyPlayListSharingSendWithBlankFields extends BaseTest {
	AssertionRepoFunctions assertionFunction = new AssertionRepoFunctions();

	@Test
	public void testVerifyPlayListSharingSendWithBlankFields() throws Exception {

		try {

			log.info("Script: VerifyPlayListSharingSendWithBlankFields");
			log.info("************************************************");
			...
			if (loginError.isDisplayed() == false) {
				...
				/*	driver.findElement(
					...
					// Verify error message is displayed for To email address
					assertTrue(
							"Error message is not displayed for To email address",
							CommonFun.isElementPresent(
									driver,
									By.xpath(XpathObjectRepo.playlistPopupToEmailErrMsg_XPATH)));
					log.info("The Error message '"
							+ driver.findElement(
									By.xpath(XpathObjectRepo.playlistPopupToEmailErrMsg_XPATH))
									.getText()
					...
					// Verify error message is displayed for email share message
					/*
					 * assertTrue(
					 * "Error message is not displayed for email share message",
					 * CommonFun.isElementPresent( driver,
					 * By.xpath(XpathObjectRepo
					 * .playlistPopupMessageErrMsg_XPATH)));
					 * log.info("The Error message '" + driver.findElement(
					 * By.xpath
					 * (XpathObjectRepo.playlistPopupMessageErrMsg_XPATH))
					 * .getText() + "' displayed for email share message");
					 */
