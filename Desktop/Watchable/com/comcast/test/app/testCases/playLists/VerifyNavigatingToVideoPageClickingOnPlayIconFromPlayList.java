...
/**
 * Class Name: VerifyNavigatingToVideoPageClickingOnPlayIconFromPlayList
 * Description: This test script verifies navigating video page after clicking
 * on play icon from play list. list. Author: Manoj
 * **/

public class VerifyNavigatingToVideoPageClickingOnPlayIconFromPlayList extends
		BaseTest {
	AssertionRepoFunctions assertionFunction = new AssertionRepoFunctions();

	@Test
	public void testVerifyNavigatingToVideoPageClickingOnPlayIconFromPlayList()
			throws Exception {

		try {

			log.info("Script: VerifyNavigatingToVideoPageClickingOnPlayIconFromPlayList");
			log.info("******************************************************************");
