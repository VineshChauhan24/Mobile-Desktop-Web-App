...
/**
 * Class Name: VerifyForgotPasswordWithInValidEmailIdFormat Description: This
 * test case verifies displaying of error message after entering invalid
 * formated email id. Author: Manoj
 * **/
...
public class VerifyForgotPasswordWithInValidEmailIdFormat extends BaseTest {
	...
	@Test
	public void testVerifyForgotPasswordWithInValidEmailIdFormat()
			throws Exception {

		try {

			log.info("Script: VerifyForgotPasswordWithInValidEmailIdFormat");
			log.info("****************************************************");
			...
			driver.findElement(
					By.id(XpathObjectRepo.forgotPasswordFormEmailText_ID))
					.sendKeys(UILablesRepo.INVALID_FORMAT_EMAIL);

			log.info("Entered the invalid formated Email ID: "
			...
			assertTrue(
					...
					CommonFun.isElementPresent(
							driver,
							By.xpath(XpathObjectRepo.forgotPasswordEmailError_XPATH)));
