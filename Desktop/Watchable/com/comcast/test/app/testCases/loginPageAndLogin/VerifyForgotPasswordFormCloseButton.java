...
/**
 * Class Name: VerifyForgotPasswordFormCloseButton Description: This test script
 * verifies clicking on close button from forgot password pop up window closing
 * the forgot password window. Author: Manoj
 * **/

public class VerifyForgotPasswordFormCloseButton extends BaseTest {

	AssertionRepoFunctions assertionFunction = new AssertionRepoFunctions();

	@Test
	public void testVerifyForgotPasswordFormCloseButton() throws Exception {

		try {

			log.info("Script: VerifyForgotPasswordFormCloseButton");
			log.info("*******************************************");
