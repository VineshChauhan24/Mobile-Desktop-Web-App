...
/**
 * Class Name: VerifyUpNexSectionInVideoPage Description: This test case
 * verifies up next section is present is video page. Author: Manoj
 * **/

public class VerifyUpNexSectionInVideoPage extends BaseTest {
	...
	@Test
	public void testVerifyUpNexSectionInVideoPage() throws Exception {

		try {

			// Test script
			log.info("Script: VerifyUpNexSectionInVideoPage");
			log.info("***********************************************");
