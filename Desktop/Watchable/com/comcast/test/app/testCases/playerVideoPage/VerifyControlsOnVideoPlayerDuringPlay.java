...
/**
 * Class Name: VerifyControlsOnVideoPlayerDuringPlay Description:This test
 * script verifies the control displaying on player in video page while video is
 * playing. Author: Manoj
 * **/

public class VerifyControlsOnVideoPlayerDuringPlay extends BaseTest {
	...
	@Test
	public void testVerifyControlsOnVideoPlayerDuringPlay() throws Exception {

		try {

			// Test script
			log.info("Script: VerifyControlsOnVideoPlayerDuringPlay");
			log.info("*********************************************");
			...
			if (videoCount > 0) {
				...
				// Verify pause button is displaying on player while playing
				// video
				assertTrue(
						"Pause button is not displaying on player while playing video",
						CommonFun.isElementPresent(driver, By
								.xpath(XpathObjectRepo.playerpauseButton_XPATH)));
				log.info("Pause button is displaying on player while playing video");
