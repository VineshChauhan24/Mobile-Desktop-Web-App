...
/**
 * Class Name: VerifyClickingOnHomeFooterLinkFromVideoPageNavigatesHomePage
 * Description: This test case click on home footer from video page, navigating
 * back to Home page. Author: Manoj
 * **/

public class VerifyClickingOnHomeFooterLinkFromVideoPageNavigatesHomePage
		extends BaseTest {
	...
	@Test
	public void testVerifyClickingOnHomeFooterLinkFromVideoPageNavigatesHomePage()
			throws Exception {

		try {

			// Test script
			log.info("Script: VerifyClickingOnHomeFooterLinkFromVideoPageNavigatesHomePage");
			log.info("*******************************************************************");
			...
			if (videoCount > 0) {
				...
				// Click on footer Home link from video detail page to
				// navigate back
				// to home page

				FooterLinkFun.clickOnHomeLink();
				AssertionRepoFunctions.assertWatchableTitle();
				log.info("Successfully Navigated to Home page after clicking on Home link from video page");
