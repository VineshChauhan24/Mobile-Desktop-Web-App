...
/**
 * Class Name: VerifyDisplayOfHeaderAndFooterInVideoPage 
 * Description: This test script verifies header and footer sections are present in video page.
 *  Author: Manoj
 * **/

public class VerifyDisplayOfHeaderAndFooterInVideoPage extends BaseTest {
	...
	@Test
	public void testVerifyDisplayOfHeaderAndFooterInVideoPage()
			throws Exception {

		try {

			// Test script
			log.info("Script: VerifyDisplayOfHeaderAndFooterInVideoPage");
			log.info("***********************************************");
			...
			if (videoCount > 0) {
				...
				assertTrue(
						"Header section is NOT present in video page",
						CommonFun.isElementPresent(driver,
								By.xpath(XpathObjectRepo.header_XPATH)));
				log.info("Header section is present in video page");

				// Scroll to Footer
				HomePageCommonFunctions.scrollToFooterSection();
				Thread.sleep(sleepTime);

				// Verify footer section is present in video page
				assertTrue(
						"Footer section is NOT present in video page",
						CommonFun.isElementPresent(driver,
								By.xpath(XpathObjectRepo.footer_XPATH)));
				log.info("Fotter section is present in video page");

				// Verifying Footer Copy Right is present in video page
				Thread.sleep(LessSleepTime);
				assertTrue(
						"Copyright text is not present in in video page",
						CommonFun.isElementPresent(
								driver,
								By.xpath(XpathObjectRepo.footerCopyRightText_XPATH)));
				log.info("Copyright text is present in in video page");
