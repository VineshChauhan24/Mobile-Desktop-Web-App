...
/**
 * Class Name: VerifyCurrentPlayingVideoTitle Description:This test script
 * verifies display of currently playing video title in video page. Author:
 * Manoj
 * **/

public class VerifyCurrentPlayingVideoTitle extends BaseTest {
	...
	@Test
	public void testVerifyCurrentPlayingVideoTitle() throws Exception {

		try {

			// Test script
			log.info("Script: VerifyCurrentPlayingVideoTitle");
			log.info("*******************************");
			...
			if (videoCount > 0) {
				...
				// Verify currently playing video title in video page
				assertTrue(
						"Currently playing video title is not present in video page",
						CommonFun.isElementPresent(driver, By
								.xpath(XpathObjectRepo.playingVideoTitle_XPATH)));
				log.info("Currently playing video title is present in video page");

				// Logging video title
				log.info("The title of the video is: "
						+ driver.findElement(
