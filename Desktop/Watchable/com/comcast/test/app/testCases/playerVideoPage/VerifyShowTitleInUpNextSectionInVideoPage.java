...
/**
 * Class Name: VerifyShowTitleInUpNextSectionInVideoPage Description: This test
 * case verifies the show title is present in Up Next section in Video page.
 * Author: Manoj
 * **/

public class VerifyShowTitleInUpNextSectionInVideoPage extends BaseTest {
	...
	@Test
	public void testVerifyShowTitleInUpNextSectionInVideoPage()
			throws Exception {

		try {

			// Test script
			log.info("Script: VerifyShowTitleInUpNextSectionInVideoPage");
			log.info("***********************************************");
