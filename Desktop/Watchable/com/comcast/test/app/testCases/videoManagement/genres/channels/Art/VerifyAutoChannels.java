package comcast.test.app.testCases.videoManagement.genres.channels.Art;
...
/**
 * Class Name: VerifyArtChannels Description: This test case validates whether
 * channels are displayed in Art Category CHANNELS PAGE in Home page by
 * with/without logging into Watchable application.
 * **/

public class VerifyAutoChannels extends BaseTest {
	...
	@Test
	public void testVerifyArtChannels() throws Exception {
