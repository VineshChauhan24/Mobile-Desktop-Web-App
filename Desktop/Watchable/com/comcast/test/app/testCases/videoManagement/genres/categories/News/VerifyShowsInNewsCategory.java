package comcast.test.app.testCases.videoManagement.genres.categories.News;
...
/**
 * Class Name: VerifyShowsInNewsAndPoliticsCategory Description: This test case
 * validates whether shows are displayed in News And Politics Category in Home
 * page by with/without logging into Watchable application.
 * **/

public class VerifyShowsInNewsCategory extends BaseTest {
	...
	@Test
	public void testVerifyShowsInNewsAndPoliticsCategory() throws Exception {

		Map<String, List<VideoDetails>> videoDetails = RestAPIServices
				.GenreCategoriesDetail(UILablesRepo.NEWS);
						...
						if (genreCategories.getTitle().equalsIgnoreCase(
							...
							for (int category = 1; category <= noOfCategoriesDisplayed; category++) {
								String getCategoryTitle = driver
										...
										.getText();
								if (getCategoryTitle
										.equalsIgnoreCase(UILablesRepo.NEWS)) {
									/*
