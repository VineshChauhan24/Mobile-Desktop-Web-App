...
/**
 * Class Name: VerifyChannelCountForHomeFeaturedBundle Description: This test
 * case is to verify the count of Channel available for a Bundle displayed under
 * 'Featured' section on 'Home' screen by logging into Gazeebo application.
 */

public class VerifyChannelCountForHomeFeaturedBundle extends BaseTest {
	...
	@Test
	public void testVerifyChannelCountForHomeFeaturedBundle() throws Exception {
		...
		try {
			...
			String ChannelsCount = driver
					...
					.getText();
			assertEquals("Channels " + ChannelCount + "", ChannelsCount);
