...
/**
 * Class Name: VerifyUpdatedStatusInHomeBundleROWSChannel Description: This test
 * case is to verify the last updated status/day for a Bundle ROWS category
 * Channel displayed under 'Featured' section on 'Home' screen by logging into
 * Gazeebo application.
 */

public class VerifyUpdatedStatusInHomeBundleROWSChannel extends BaseTest {
	...
	@Test
	public void testVerifyUpdatedStatusInHomeBundleROWSChannel()
			throws Exception {
