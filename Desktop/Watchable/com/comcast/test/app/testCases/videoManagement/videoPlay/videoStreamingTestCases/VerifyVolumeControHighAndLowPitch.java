 ...
 * current positon in video player by logging into Gazeebo application.
 * **/
		...
		try {
			...
			if (loginError == 0) {
				...
				if (videoList != null) {
					...
					getEndPosition = Integer
							.valueOf(tempendPosition.intValue()).toString();
					...
					for (int i = 0; i < 2; i++) {
						...
						if (currPostion < lastPosition) {
							...
							// String
							// currentVolume=flashApp.callFlashObject("adjustVolume");
