...
public class VerifyShowsInComedyCategory extends BaseTest {
	...
	@Test
	public void testVerifyShowsInComedyCategory() throws Exception {
								...
								if (genreCategoriesShowsList != null) {
									...
									for (int index = 0; index < loopMaxIndex; index++) {
										...
										for (; i <= listIndex; i++) {
											...
											// int ele =
											// driver.findElements(By.xpath(XpathObjectRepo.CHANNELDETAILSPAGETITLE_XPATH)).size();
											// if(ele == 1) {
											// assertTrue(driver.findElement(By.xpath(XpathObjectRepo.CHANNELDETAILSPAGETITLE_XPATH)).getText().equalsIgnoreCase(showList.getTitle()));
											// }
