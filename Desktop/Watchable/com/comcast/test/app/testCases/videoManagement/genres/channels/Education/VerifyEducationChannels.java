package comcast.test.app.testCases.videoManagement.genres.channels.Education;
...
/**
 * Class Name: VerifyEducationChannels Description: This test case validates
 * whether channels are displayed in Education Category CHANNELS PAGE in Home
 * page by with/without logging into Watchable application.
 * **/

public class VerifyEducationChannels extends BaseTest {
	...
	@Test
	public void testVerifyEducationChannels() throws Exception {

		Map<String, List<VideoDetails>> videoDetails = RestAPIServices
				.GenreCategoriesDetail(UILablesRepo.EDUCATION);
				...
				for (int category = 1; category <= noOfCategoriesDisplayed; category++) {
					if (noOfCategoriesDisplayed <= 8) {
						String getCategoryTitle = driver
								...
								.getText();
						if (getCategoryTitle
								.equalsIgnoreCase(UILablesRepo.EDUCATION)) {
							categoryFound = true;
