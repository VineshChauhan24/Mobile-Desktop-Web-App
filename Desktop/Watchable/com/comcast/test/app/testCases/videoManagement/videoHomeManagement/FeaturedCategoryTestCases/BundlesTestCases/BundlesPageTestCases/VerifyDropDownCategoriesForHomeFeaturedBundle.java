...
/**
 * Class Name: VerifyDropDownCategoriesForHomeFeaturedBundle Description: This
 * test case verifies the category of available dropdowns for a Bundle displayed
 * under 'Featured' section on 'Home' screen by logging into Gazeebo
 * application.
 */

public class VerifyDropDownCategoriesForHomeFeaturedBundle extends BaseTest {
	...
	@Test
	public void testVerifyDropDownsForHomeFeaturedBundles() throws Exception {

		Map<String, List<VideoDetails>> videoDetails = RestAPIServices
				.FeaturedBundleAPI();
		List<VideoDetails> bundlesList = videoDetails.get("bundlesList");
		List<VideoDetails> ChannelsListInBundle = videoDetails
				.get("showsInBundle");
		...
		try {
			...
			Thread.sleep(sleepTime);
			driver.findElement(By.xpath("//option[@value='hd']")).click();
