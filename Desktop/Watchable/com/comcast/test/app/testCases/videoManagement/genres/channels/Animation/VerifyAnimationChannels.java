package comcast.test.app.testCases.videoManagement.genres.channels.Animation;
...
/**
 * Class Name: VerifyAnimationAndGamesChannels Description: This test case
 * validates whether channels are displayed in Animations and Games Category
 * CHANNELS PAGE in Home page by with/without logging into Watchable
 * application.
 * **/

public class VerifyAnimationChannels extends BaseTest {
	...
	@Test
	public void testVerifyAnimationChannels() throws Exception {
		...
		try {
			...
			// driver.findElement(By.xpath(".//*[@id='genre']/div/div[1]/header/nav/ul/li[2]/a")).click();
			driver.findElement(
							...
							for (int index = 0; index < loopMaxIndex; index++) {
								...
								for (; i <= listIndex; i++) {
									...
									if (ele == 1) {
										...
										Reporter.log("Channel not present");
			...
			// Lekshmi : Commented the method as it is not required.
			/*
			 * if(categoryFound==false) //Lekshmi : Change the object identifier
			 * /
			 * /assertTrue(driver.findElement(By.cssSelector("BODY")).getText().
			 * matches
			 * ("^[\\s\\S]*"+orProUtil.getProperty("ANIMATION")+"[\\s\\S]*$"));
			 * assertTrue(driver.findElement(By.xpath(XpathObjectRepo.
			 * HOMEGENRECHANNELANIMATIONTITLE_XPATH
