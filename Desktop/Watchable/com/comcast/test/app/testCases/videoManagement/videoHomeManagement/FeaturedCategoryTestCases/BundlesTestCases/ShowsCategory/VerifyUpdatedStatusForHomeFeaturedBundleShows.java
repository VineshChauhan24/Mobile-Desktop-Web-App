package comcast.test.app.testCases.videoManagement.videoHomeManagement.FeaturedCategoryTestCases.BundlesTestCases.ShowsCategory;
...
/**
 * Class Name: VerifyUpdatedStatusForHomeFeaturedBundleShows Description: This
 * test case is to verify the shown last updated status/day for a Shows by
 * clicking on SHOWS link under bundle for 'Featured' 'Home' screen by logging
 * into Gazeebo application.
 */

public class VerifyUpdatedStatusForHomeFeaturedBundleShows extends BaseTest {
	...
	@Test
	public void testVerifyUpdatedDayForHomeFeaturedBundleShows()
			throws Exception {
