...
/**
 * Class Name: VerifyUpdatedStatusForHomeBundleCHANNELS_SHOWS Description: This
 * test case is to verify the shown last updated status/day for a Shows
 * displayed under Store Featured > Bundle > CHANNELS > SHOWS by logging into
 * Comcast application.
 */

public class VerifyUpdatedStatusForHomeBundleCHANNELS_SHOWS extends BaseTest {
	...
	@Test
	public void testVerifyUpdatedStatusForHomeBundleCHANNELS_SHOWS()
			throws Exception {
		...
		try {
			...
			String Videocount = driver
					...
					.getText();
			assertEquals("Updated 2 weeks ago", Videocount);
