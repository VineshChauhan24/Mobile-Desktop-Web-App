package comcast.test.app.testCases.videoManagement.videoHomeManagement.FeaturedCategoryTestCases.BundlesTestCases.ChannelsCategory.VideosCategory;
...
/**
 * Class Name: VerifyVideosInHomeBundleCHANNELS_VIDEOS Description: This test
 * case is to verify the available videos in 'Home' Bundle > CHANNELS > VIDEOS
 * for a bundle channel displayed under 'Featured' section on 'Store' screen by
 * logging into Comcast application.
 */

public class VerifyVideosInHomeBundleCHANNELS_VIDEOS extends BaseTest {
	...
	@Test
	public void testVerifyVideosInHomeBundleCHANNELS_VIDEOS() throws Exception {
