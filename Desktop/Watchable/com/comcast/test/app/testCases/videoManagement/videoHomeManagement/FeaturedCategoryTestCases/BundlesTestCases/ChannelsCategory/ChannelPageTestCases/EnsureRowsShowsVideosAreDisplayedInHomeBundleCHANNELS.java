...
/**
 * Class Name: EnsureRowsShowsVideosAreDisplayedInHomeBundleCHANNELS
 * Description: This test case is to verify and ensure if 'Rows','Shows' and
 * 'Videos' links are present for a Bundle CHANNELS category displayed under
 * 'Featured' section on 'Home' screen by logging into Gazeebo application with
 * registered user.
 */

public class EnsureRowsShowsVideosAreDisplayedInHomeBundleCHANNELS extends
		BaseTest {
	...
	@Test
	public void testEnsureRowsShowsVideosAreDisplayedInHomeBundleCHANNELS()
			throws Exception {
