package comcast.test.app.testCases.videoManagement.genres.channels.Film;
...
/**
 * Class Name: VerifyFilmChannels Description: This test case validates whether
 * channels are displayed in Film Category CHANNELS PAGE in Home page by
 * with/without logging into Watchable application.
 * **/

public class VerifyEntertainmentChannels extends BaseTest {
	...
	@Test
	public void testVerifyEntertainmentChannels() throws Exception {
