...
/**
 * Class Name: VerifySearchByEnteringSplCharacters Description: This test case
 * is used to validate whether search feature working for special characters by
	...
	public void testVerifySearchByEnteringSplCharacters() throws Exception {
		try {
			...
			if (loginError == 0) {
				...
				// This method asserts Watchable Logo is present in the page.
				...
				driver.findElement(
						...
						.sendKeys(proUtil.getProperty("SEARCH_BY_SPLCHAR"));
				driver.findElement(
