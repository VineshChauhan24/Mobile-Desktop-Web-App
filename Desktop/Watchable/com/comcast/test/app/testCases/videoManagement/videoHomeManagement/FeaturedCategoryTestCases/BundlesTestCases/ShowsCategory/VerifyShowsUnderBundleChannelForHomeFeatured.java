...
/**
 * Class Name: VerifyShowsUnderBundleChannelForHomeFeatured Description: This
 * test case is to verify the available Shows clicking on 'SHOWS' link under
 * bundle which displayed under 'Featured' section on 'Home' screen by logging
 * into Gazeebo application.
 */

public class VerifyShowsUnderBundleChannelForHomeFeatured extends BaseTest {
	...
	@Test
	public void testVerifyShowsUnderBundleChannelForHomeFeatured()
			throws Exception {
