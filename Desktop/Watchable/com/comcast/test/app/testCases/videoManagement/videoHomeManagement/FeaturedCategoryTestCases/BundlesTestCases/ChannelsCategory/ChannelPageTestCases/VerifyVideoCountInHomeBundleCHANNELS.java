...
/**
 * Class Name: VerifyVideoCountInHomeBundleCHANNELS Description: This test case
 * is to verify the count of videos available for a Channels in Bundle CHANNELS
 * displayed under 'Featured' section on 'Home' screen by logging into Gazeebo
 * application.
 */

public class VerifyVideoCountInHomeBundleCHANNELS extends BaseTest {
	...
	@Test
	public void testVerifyVideoCountInHomeBundleCHANNELS() throws Exception {

		Map<String, List<VideoDetails>> videoDetails = RestAPIServices
				.FeaturedBundleAPI();
		Map<String, List<VideoDetails>> EpisodeDetails = RestAPIServices
				.episodeListUnderBundle();

		List<VideoDetails> BundleChannelList = videoDetails
				.get("showsInBundle");
		List<VideoDetails> episodeListbundle = EpisodeDetails
				.get("episodeCountInBundle");
		...
		try {
			...
			String Videocount = driver
					...
					.getText();
			assertEquals("Videos " + episodeListbundle.get(0).getNoOfHits()
					+ "", Videocount);
