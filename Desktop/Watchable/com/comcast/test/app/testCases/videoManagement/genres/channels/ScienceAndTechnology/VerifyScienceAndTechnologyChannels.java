package comcast.test.app.testCases.videoManagement.genres.channels.ScienceAndTechnology;
...
/**
 * Class Name: VerifyScienceAndTechnologyChannels Description: This test case
 * validates whether channels are displayed in Science And Technology Category
 * CHANNELS PAGE in Home page by with/without logging into Watchable
 * application.
 * **/

public class VerifyScienceAndTechnologyChannels extends BaseTest {
	...
	@Test
	public void testVerifyScienceAndTechnologyChannels() throws Exception {
							...
							for (int index = 0; index < loopMaxIndex; index++) {
								...
								for (; i <= listIndex; i++) {
									...
									if (ele == 1) {
										...
										log.error("Failed to navigate to Genre CHANNELS page");
									}
