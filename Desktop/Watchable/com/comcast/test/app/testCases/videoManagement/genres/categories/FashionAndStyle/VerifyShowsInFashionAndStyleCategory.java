package comcast.test.app.testCases.videoManagement.genres.categories.FashionAndStyle;
...
/**
 * Class Name: VerifyShowsInFashionAndStyleCategory Description: This test case
 * validates whether shows are displayed in Fashion & Style Category in Home
 * page by with/without logging into Watchable application.
 * **/

public class VerifyShowsInFashionAndStyleCategory extends BaseTest {
	...
	@Test
	public void testVerifyShowsInFashionAndStyleCategory() throws Exception {

		Map<String, List<VideoDetails>> videoDetails = RestAPIServices
				.GenreCategoriesDetail(UILablesRepo.FASHIONANDSTYLE);
		...
		try {
			...
			// Login is not required this script..
					...
					if (genreCategories.getTitle().equalsIgnoreCase(
						...
						for (int category = 1; category <= noOfCategoriesDisplayed; category++) {
							String getCategoryTitle = driver
									...
									.getText();
							if (getCategoryTitle
									.equalsIgnoreCase(UILablesRepo.FASHIONANDSTYLE)) {
								/*
						 ...
						 * .HOMEPAGE_GENRE_FASHIONSTYLE_HEADER_XPATH
						 * )).getText().matches(UILablesRepo.FASHIONANDSTYLE));
						 */
					}
					if (categoryFound == true)
						break;
