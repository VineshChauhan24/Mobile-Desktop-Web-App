...
/**
 * Class Name: PlayHomePopularChannelsVideoFromRows Description: This test case
 * is to play the video from SHOWS category by directly selecting the videos in
 * the channel page for 'Popular Channels' section in Home page.
 * **/
		...
		try {
			...
			if (loginError == 0) {
				...
				if (channelList != null) {
					...
					// driver.findElement(By.xpath(XpathObjectRepo.CHANNELDETAILSFIRSTSHOWTITLE_XPATH)).click();

					// Lekshmi : Clicks on the episode in the Channel Details
					// page.
					driver.findElement(
							By.xpath(XpathObjectRepo.CHANNELDETAILSFIRSTEPISODETITLE_XPATH))
							.click();
