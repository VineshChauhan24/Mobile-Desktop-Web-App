...
/**
 * Class Name: VerifyVideoCountForHomeFeaturedShow Description: This test case
 * validates whether 'Videos' count is displayed in show page for the show
 * present in a channel under Featured section in Home page by logging
...
public class VerifyVideoCountForHomeFeaturedShow extends BaseTest {
	...
	@Test
	public void testVerifyVideoCountForHomeFeaturedShow() throws Exception {
		...
		try {
			...
			// its collapsed.
			// assertionFunction.assertGazeeboTopMiddleMenu(); - Function
			...
			if (channelList != null) {
				...
				if (showListUnderChannel != null) {
					...
					for (int index = 0; index < loopMaxIndex; index++) {
						...
						Thread.sleep(sleepTime);
						// assertEquals("Videos "+showList.getNumOfVideos()+"",driver.findElement(By.xpath(".//*[@id='content-wrap']/article/div/div[2]/div/div[1]/ul/li[1]")).getText());

						assertEquals(
								"Videos " + showList.getNumOfVideos() + "",
								driver.findElement(
