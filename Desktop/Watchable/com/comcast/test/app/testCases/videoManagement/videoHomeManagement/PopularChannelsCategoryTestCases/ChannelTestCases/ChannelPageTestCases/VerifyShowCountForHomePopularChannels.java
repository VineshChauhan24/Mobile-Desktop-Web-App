...
/**
 * Class Name: VerifyShowCountForHomePopularChannels Description: This test case
 * validates whether Shows count is displayed in channel page for the channel
 * present under Popular Channels section in Home page by logging registered
			...
			if (loginError == 0) {
				...
				if (channelList != null) {
					...
					if (channelList.size() < 4)
						...
						loopMaxIndex = 4;
					String noOfShowsLabel_XPATH = driver
							.findElement(
					...
					for (int index = 0; index < loopMaxIndex; index++) {
						...
						int pos = index + 1;
						int noOfShows = Integer.parseInt(channels
								.getNumOfShows());
						if (noOfShows == 0) {
							assertTrue(driver
									.findElement(
						...
						String Showcount = driver
								.findElement(
										By.xpath(XpathObjectRepo.CHANNELDETAILSPAGESHOWSDATA_XPATH))
								.getText();
						assertEquals(UILablesRepo.CHANNELDETAILSPAGE_SHOWS_TEXT
								+ channels.getNumOfShows() + "", Showcount);
