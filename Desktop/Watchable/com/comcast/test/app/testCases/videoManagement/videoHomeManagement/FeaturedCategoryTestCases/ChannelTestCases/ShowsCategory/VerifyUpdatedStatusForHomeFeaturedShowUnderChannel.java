...
/**
 * Class Name: VerifyUpdatedStatusForHomeFeaturedShowUnderChannel Description:
 * This test case validates whether 'Updated' status is displayed in shows page
 * for the show present in channel under Featured section in Home page by
 * logging registered user into Watchable application.
 * **/

public class VerifyUpdatedStatusForHomeFeaturedShowUnderChannel extends
		BaseTest {
	...
	@Test
	public void testVerifyUpdatedStatusForHomeFeaturedShowUnderChannel()
			throws Exception {
