...
/**
 * Class Name: VerifyHomeFeaturedAllBundlesAreDisplayed Description: This test
 * case is to verify Home/Featured category all bundles are displayed and
 * clickable by comparing with Featured API response for registered Gazeebo
 * Application user.
 * **/
...
public class VerifyHomeFeaturedAllBundlesAreDisplayed extends BaseTest {
	...
	public void testVerifyHomeFeaturedAllBundlesAreDisplayed() throws Exception {
		...
		Map<String, List<VideoDetails>> videoDetails = RestAPIServices
				.FeaturedBundleAPI();
		List<VideoDetails> featuredBundlesList = videoDetails
				.get("bundlesList");
