 ...
 * after clicking double clicking on EPISODES link, in show details page for the
 * channel present under Featured section in Home page by logging registered
 * user into Watchable application.
 * **/

public class VerifyFeaturedDuplicateEpisodesWhenDoubleClickOnEpisodesLink
		extends BaseTest {
	...
	@Test
	public void testVerifyFeaturedDuplicateEpisodesWhenDoubleClickOnEpisodesLink()
			throws Exception {
		...
		Map<String, List<VideoDetails>> showDetails = RestAPIServices
				.nHomeFeaturedAPI();
		List<VideoDetails> showListUnderChannel = showDetails
		...
		try {
			...
			// Includes the xpath element by commenting the above line by
			// lekshmi
			// driver.findElement(By.xpath("//*[@id='seq-row-list']/div[2]/div[2]/section/ul/li/article/h1/a")).click();
			driver.findElement(
					By.xpath("li[contains(@class,'cell-show')]/descendant::h1/a"))
					.click();
			...
			action.doubleClick(driver.findElement(By
					.xpath("//*[@id='seq-row-list']/div[2]/div[2]/section/ul/li/article/h1/a")));
			action.perform();
