...
/**
 * Class Name: VerifyShowsAndVideosForHomeBundleChannelInRows Description: This
 * test case is to verify Shows and Video after sorting by 'ROWS'for a Bundle
 * Channel displayed under 'Featured' section on 'Home' Rows category screen by
...
public class VerifyShowsAndVideosForHomeBundleChannelInRows extends BaseTest {
	...
	@Test
	public void testVerifyShowsAndVideosForHomeBundleChannelInRows()
			throws Exception {
		...
		try {
			...
			driver.findElement(
					By.linkText(ChannelsListUnderBundleRows.get(
			...
			assertTrue(driver
					...
					.matches(
							"^[\\s\\S]*"
									+ ChannelsListUnderBundleRows.get(
