...
/**
 * Class Name: VerifyVideosUnderHomeBundleROWSChannelVIDEOS Description: This
 * test case is to verify the available Videos under Bundle ROWS by selecting
 * any channel and VIDEOS for 'Featured' section on 'Home' screen by logging
 * into Gazeebo application.
 */

public class VerifyVideosUnderHomeBundleROWSChannelVIDEOS extends BaseTest {
	...
	@Test
	public void testVerifyVideosUnderHomeBundleROWSChannelVIDEOS()
			throws Exception {
