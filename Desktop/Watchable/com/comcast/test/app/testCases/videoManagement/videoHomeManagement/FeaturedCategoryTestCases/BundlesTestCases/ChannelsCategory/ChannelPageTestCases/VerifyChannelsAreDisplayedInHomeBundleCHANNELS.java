...
/**
 * Class Name: VerifyChannelsAreDisplayedInHomeBundleCHANNELS Description: This
 * test case is to verify and ensure if channels displayed for a Bundle channel
 * present under 'Featured' section on 'Home' screen by logging into Gazeebo
 * application with registered user.
 */

public class VerifyChannelsAreDisplayedInHomeBundleCHANNELS extends BaseTest {
	...
	@Test
	public void testVerifyChannelsAreDisplayedInHomeBundleCHANNELS()
			throws Exception {
