 ...
 * Description: This test case is to play Videos by clicking on Show in Bundle >
 * CHANNEL > ROWS for a Bundle displayed under 'Featured' section on 'Home'
 * screen by logging into Gazeebo application.
 */

public class PlayHBVideosByClickingOnShowInStoreBundleCHANNELS_ROWS extends
		BaseTest {
	...
	@Test
	public void testPlayHBVideosByClickingOnShowInStoreBundleCHANNELS_ROWS()
			throws Exception {
