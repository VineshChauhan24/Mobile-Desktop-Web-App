...
/**
 * Class Name: VerifyUpdatedStatusForSubscribedChannel Description: This test
 * case is to verify the shown last updated status/day for a subscribed channel
...
public class VerifyUpdatedStatusForSubscribedChannel extends BaseTest {
	...
	@Test
	public void testVerifyUpdatedStatusForSubscribedChannel() throws Exception {
				...
				if (channelList != null) {
					...
					for (int index = 0; index < loopIndexMax; index++) {
						...
						String publishedDate = driver
								...
								.getText();
						assertEquals(channelDetails.getLastPublished(),
								publishedDate);
