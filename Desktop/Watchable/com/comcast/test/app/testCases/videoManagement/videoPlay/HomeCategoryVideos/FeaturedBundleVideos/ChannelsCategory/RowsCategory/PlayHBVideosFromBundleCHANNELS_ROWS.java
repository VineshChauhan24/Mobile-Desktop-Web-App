...
/**
 * Class Name: PlayHBVideosFromBundleCHANNELS_ROWS Description: This test case
 * is to Play video in Bundle > CHANNEL > ROWS for a Bundle displayed under
 * 'Featured' section on 'Home' screen by logging into Gazeebo application.
 */

public class PlayHBVideosFromBundleCHANNELS_ROWS extends BaseTest {
	...
	@Test
	public void testPlayHBVideosFromBundleCHANNELS_ROWS() throws Exception {
