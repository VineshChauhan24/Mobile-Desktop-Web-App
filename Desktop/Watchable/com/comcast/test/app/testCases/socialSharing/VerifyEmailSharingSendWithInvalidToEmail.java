...
/**
 * Class Name: VerifyEmailSharingSendWithInvalidToEmail Description: This test
 * script verifies clicking on send button from email sharing pop up window by
 * entering invalid to email address displaying error message for both fields.
 * Author: Manoj
 * **/

public class VerifyEmailSharingSendWithInvalidToEmail extends BaseTest {
	@Test
	public void testVerifyEmailSharingSendWithInvalidToEmail() throws Exception {

		try {

			// Test script
			log.info("Script: VerifyEmailSharingSendWithInvalidToEmail");
			log.info("************************************************");
			...
			if (loginError.isDisplayed() == false) {
				...
				if (videoCount > 0) {
					...
					if (driver.findElement(
						...
						SocialSharingFun.emterFromToEmailAddress(UILablesRepo.INVALID_FORMAT_EMAIL);
