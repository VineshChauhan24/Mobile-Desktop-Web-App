...
/**
 * Class Name: VerifyEmailSharingFormMessageContentDescription: This test script
 * verifies the message box in email sharing pop up window is Pre-populated with
 * video URL. 
 * Author: Manoj
 * **/

public class VerifyEmailSharingFormMessageContent extends BaseTest {
	@Test
	public void testVerifyEmailSharingFormMessageContent() throws Exception {

		try {

			// Test script
			log.info("Script: VerifyEmailSharingFormMessageContent");
			log.info("************************************************");
			...
			if (loginError.isDisplayed() == false) {
				...
				if (videoCount > 0) {
					...
					if (driver.findElement(
						...
						//Functionality removed now, so commenting the assertion

						/*assertTrue(
								"The message text box does not contains video URL",
								msgText.contains(videoUrl));
						log.info("The message text box contains video URL");*/
					}
