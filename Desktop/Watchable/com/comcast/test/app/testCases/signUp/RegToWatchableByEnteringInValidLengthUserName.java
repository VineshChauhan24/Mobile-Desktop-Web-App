...
/**
 * Class Name: RegToWatchableByEnteringInValidLengthUserName Description: This
 * test case is to validated registration by providing invalid length user name
 * Author: Manoj
 * **/

public class RegToWatchableByEnteringInValidLengthUserName extends BaseTest {

	AssertionRepoFunctions assertionFunction = new AssertionRepoFunctions();

	@Test
	public void testRegToWatchableByEnteringInValidLengthUserName()
			throws Exception {

		try {

			log.info("Script: RegToWatchableByEnteringInValidLengthUserName");
			log.info("*****************************************************");
			...
			SignUpFun.enterSignUpDetails(driver,
					UILablesRepo.INVALID_USERNAME_LENGTH, UILablesRepo.NEWUSER,
