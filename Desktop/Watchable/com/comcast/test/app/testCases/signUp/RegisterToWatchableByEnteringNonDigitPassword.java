 ...
 * test case try registers to Watchable application entering non digit password.
 * Author: Manoj
 * **/
...
public class RegisterToWatchableByEnteringNonDigitPassword extends BaseTest {
	...
	public void testRegisterToWatchableByEnteringNonDigitPassword()
		...
		try {
			...
			log.info("Script: RegisterToWatchableByEnteringNonDigitPassword");
			log.info("*****************************************************");
			...
			SignUpFun.enterSignUpDetails(driver, UILablesRepo.NEWUSERNAME,
					UILablesRepo.NEWUSER, UILablesRepo.INVALID_PASSWORD);

			// Select Terms And conditions check box
			SignUpFun.selectTermsConditionsCheck();

			// click on SIGN UP button entering non digit
			// password.
			...
			log.info("As per the business requirement, Password is now accepting withot Digits");
