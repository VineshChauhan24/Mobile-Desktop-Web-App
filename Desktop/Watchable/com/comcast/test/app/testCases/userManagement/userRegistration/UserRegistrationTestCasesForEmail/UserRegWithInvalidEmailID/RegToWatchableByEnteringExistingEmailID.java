...
/**
 * Class Name: RegToGazeeboByEnteringExistingEmailID Description: This test case
 * is to validated registration by providing existing user email
 * **/
...
public class RegToWatchableByEnteringExistingEmailID extends BaseTest {
	...
	public void testRegToWatchableByEnteringExistingEmailID() throws Exception {
		...
		try {
			...
			// page
			userRegValidationFun.validateInvalidEmailID(driver, Email,
			...
			assertTrue(driver
					.findElement(
							By.xpath(XpathObjectRepo.SIGNUP_DUPEMAILID_USAGE_WARNING_XPATH))
					.getText()
					.equalsIgnoreCase(
							UILablesRepo.SIGNUP_DUPEMAILID_USAGE_WARNING_MSG));
