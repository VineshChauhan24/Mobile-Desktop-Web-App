 ...
 * registers to Gazeebo application without entering invalid confirm password.
 * **/
	...
	public void testRegToWatchableByProvidingDifferentConfPass()
		...
		try {
			...
			userRegValidationFun.validateUserRegistrationFields(driver,
					...
					proUtil.getProperty("CONFIRMATION_PASS"));
			...
			assertTrue(driver
					...
					.getText()
					.matches(
							"^[\\s\\S]*Please enter the same value as your password.[\\s\\S]*$"));
