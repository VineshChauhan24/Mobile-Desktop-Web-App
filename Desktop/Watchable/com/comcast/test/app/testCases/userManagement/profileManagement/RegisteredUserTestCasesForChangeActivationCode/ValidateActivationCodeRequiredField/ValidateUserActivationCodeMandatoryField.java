...
/**
 * Class Name: ValidateUserActivationCodeMandatoryField Description: This test
 * case validates if user activation code is the mandatory field by logging
	...
	public void testValidateUserActivationCodeMandatoryField() throws Exception {
		try {
			...
			assertEquals(
					...
					driver.findElement(
							By.xpath("//*[@id='step-2']/fieldset[1]/div[2]/label/label"))
							.getText());
