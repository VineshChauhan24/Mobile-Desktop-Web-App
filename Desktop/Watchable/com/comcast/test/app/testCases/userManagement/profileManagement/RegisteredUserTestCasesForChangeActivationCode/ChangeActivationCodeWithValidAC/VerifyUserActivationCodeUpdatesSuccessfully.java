...
/**
 * Class Name: VerifyUserActivationCodeUpdatesSuccessfully Description: This
 * test case validates activation code is updated successfully by logging
...
public class VerifyUserActivationCodeUpdatesSuccessfully extends BaseTest {
	...
	@Test
	public void testVerifyUserActivationCodeUpdatesSuccessfully()
			throws Exception {
		...
		try {
			...
			profManagementScenario.UpdateActivationCode(driver,
					proUtil.getProperty("UPD_ACTIVATION_CODE"));
			...
			/*
			 * .........Ensuring the updated Activation code is
			 * pending............
			 */
