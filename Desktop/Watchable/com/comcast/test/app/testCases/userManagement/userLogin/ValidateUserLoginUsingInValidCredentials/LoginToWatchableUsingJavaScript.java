...
/**
 * Class Name: LoginToGazeeboUsingJavaScript Description: This test case is used
 * to login to Gazeebo application by entering username as JavaScript and valid
 * password.
 * **/
...
public class LoginToWatchableUsingJavaScript extends BaseTest {
	...
	public void testLoginToWatchableUsingJavaScript() throws Exception {
		...
		loginFuntion.LoginToXidioApplication(driver,
				proUtil.getProperty("JS_USERNAME"),
