...
/**
 * Class Name: VerifyNavigatingToChannelPageFromMyWatchlistPage Description:
 * This test case verifies navigating to show page by clicking on channel
 * title from video section. Author: Manoj
 * **/

public class VerifyNavigatingToChannelPageFromMyWatchlistPage extends BaseTest {
	AssertionRepoFunctions assertionFunction = new AssertionRepoFunctions();

	@Test
	public void testVerifyNavigatingToChannelPageFromMyWatchlistPage()
			throws Exception {

		try {

			log.info("Script: VerifyNavigatingToChannelPageFromMyWatchlistPage");
			log.info("********************************************************");
			...
			if (loginError.isDisplayed() == false) {
				...
				if (videoCount > 0) {
					...
					log.info("myShowsShowTitle: " + myShowsShowTitle);
					...
					log.info("showsPageShowTitle: " + showsPageShowTitle);
