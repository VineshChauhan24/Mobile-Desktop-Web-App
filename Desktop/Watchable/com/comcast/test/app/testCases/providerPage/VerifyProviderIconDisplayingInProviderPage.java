...
/**
 * Class Name: VerifyProviderIconDisplayingInProviderPage 
 * Description: This test script verifies provider icon is displaying in provider detail page. 
 * Author: Manoj
 * **/

public class VerifyProviderIconDisplayingInProviderPage extends BaseTest {
	...
	@Test
	public void testVerifyProviderIconDisplayingInProviderPage()
			throws Exception {

		try {

			// Test script
			log.info("Script: VerifyProviderIconDisplayingInProviderPage");
			log.info("**************************************************");
