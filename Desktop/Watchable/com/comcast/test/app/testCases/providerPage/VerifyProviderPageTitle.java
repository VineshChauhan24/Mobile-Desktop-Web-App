...
/**
 * Class Name: VerifyProviderPageTitle Description: This test case verifies the
 * title of the provider page. Author: Manoj
 * **/

public class VerifyProviderPageTitle extends BaseTest {
	...
	@Test
	public void testVerifyProviderPageTitle() throws Exception {

		try {

			// Test script
			log.info("Script: VerifyProviderPageTitle");
			log.info("**************************************");
			...
			if (channelCount > 0) {
				...
				// Verify Provider page title

				log.info("The Provider page title displayed is '"
						+ driver.getTitle() + "'");
