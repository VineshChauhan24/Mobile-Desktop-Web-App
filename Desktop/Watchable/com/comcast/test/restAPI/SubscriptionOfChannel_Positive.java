...
public class SubscriptionOfChannel_Positive {
	...
	public void testVerifyStoreCategoryVideosAreDisplayed() throws Exception {
		...
		Thread.sleep(sleepTime);
		assertTrue(driver.findElement(By.cssSelector("BODY")).getText()
				.matches("^[\\s\\S]*500 Days of Summer[\\s\\S]*$"));
		...
		Thread.sleep(sleepTime);
		driver.findElement(
				By.xpath(".//*[@id='content-wrap']/article/section/article/div/div/section/ul/li[1]/article/h1/a"))
				.click();
