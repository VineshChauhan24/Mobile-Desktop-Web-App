...
/**
 * Class Name: VeriyContactUsEmailFieldPopulatedWithEmailLoginWithUserName
 * Description: This test scripts verifies the email field in contact us form is
 * pre populated with email address after login with user name. 
 * Author: Manoj
 * **/

public class VeriyContactUsEmailFieldPopulatedWithEmailLoginWithUserName extends
		BaseTest {
	AssertionRepoFunctions assertionFunction = new AssertionRepoFunctions();

	@Test
	public void testVeriyContactUsEmailFieldPopulatedWithEmailLoginWithUserName()
			throws Exception {

		try {

			log.info("Script: VeriyContactUsEmailFieldPopulatedWithEmailLoginWithUserName");
			log.info("*******************************************************************");
			...
			if (loginError.isDisplayed() == false) {
				...
				// select reason from reason list to display Message and email
				// text box in contact us form
