...
/**
 * Class Name: VerifyClickOnWatchableLogoFromVideoPageNavigatesHomePage
 * Description: This test script verifies clicking on watchable logo from video
 * page user is taking back to home page. Author: Manoj
 * **/

public class VerifyClickOnWatchableLogoFromVideoPageNavigatesHomePage extends
		BaseTest {
	...
	@Test
	public void testVerifyClickOnWatchableLogoFromVideoPageNavigatesHomePage()
			throws Exception {

		try {

			// Test script
			log.info("Script: VerifyClickOnWatchableLogoFromVideoPageNavigatesHomePage");
			log.info("****************************************************************");
			...
			if (videoCount > 0) {
				...
				// Click on Top Watchable logo from channel detail page to
				// navigate
				// back
				// to home page
				...
				// Watchable log from video page
				AssertionRepoFunctions.assertWatchableTitle();
				log.info("Successfully Navigated to Home page after clicking on Watchable logo from Video Page");
				log.info("");
