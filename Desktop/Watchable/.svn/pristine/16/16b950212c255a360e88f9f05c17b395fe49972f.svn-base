...
/**
 * Class Name: SearchWithDigitsKey Description: TThis test script verify search
 * functionality by searching with digits as search key. Author: Manoj
 * **/

public class SearchWithDigitsKey extends BaseTest {

	AssertionRepoFunctions assertionFunction = new AssertionRepoFunctions();

	@Test
	public void testSearchWithDigitsKey() throws Exception {

		try {

			log.info("Script: SearchWithDigitsKey");
			log.info("**************************");
			...
			searchFun
					.enterSearchStringPressEnterKey(UILablesRepo.SEARCH_DIGITS_KEY);
