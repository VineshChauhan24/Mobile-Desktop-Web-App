...
/**
 * Class Name: SearchWithProviderId Description: This test script verify search
 * functionality by searching with provider ID. Author: Manoj
 * **/

public class SearchWithProviderId extends BaseTest {

	AssertionRepoFunctions assertionFunction = new AssertionRepoFunctions();

	@Test
	public void testSearchWithProviderId() throws Exception {

		try {

			log.info("Script: SearchWithProviderId");
			log.info("****************************");
			...
			searchFun
					.enterSearchStringPressEnterKey(UILablesRepo.SEARCH_PROVIDER_ID);
