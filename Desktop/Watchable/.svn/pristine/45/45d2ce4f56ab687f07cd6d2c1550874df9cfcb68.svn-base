...
/**
 * Class Name: RegToWatchableByEnteringInValidUserName Description: This test
 * case is to validated registration by providing invalid user name 
 * Author: Manoj
 * **/

public class RegToWatchableByEnteringInValidUserName extends BaseTest {

	AssertionRepoFunctions assertionFunction = new AssertionRepoFunctions();

	@Test
	public void testRegToWatchableByEnteringInValidUserName() throws Exception {

		try {

			log.info("Script: RegToWatchableByEnteringInValidUserName");
			log.info("***********************************************");
