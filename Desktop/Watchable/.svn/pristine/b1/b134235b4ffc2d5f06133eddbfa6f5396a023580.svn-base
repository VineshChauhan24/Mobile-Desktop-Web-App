...
/**
 * Class Name: VerifyForgotPasswordWithInValidEmailId Description: This test
 * case verifies displaying of error message after entering invalid(not
 * registered) email id. Author: Manoj
 * **/

public class VerifyForgotPasswordWithInValidEmailId extends BaseTest {

	AssertionRepoFunctions assertionFunction = new AssertionRepoFunctions();

	@Test
	public void testVerifyForgotPasswordWithInValidEmailId() throws Exception {

		try {

			log.info("Script: VerifyForgotPasswordWithInValidEmailId");
			log.info("**********************************************");
			...
			driver.findElement(
					By.id(XpathObjectRepo.forgotPasswordFormEmailText_ID))
					.sendKeys(UILablesRepo.INVALID_USER_NAME);

			log.info("Entered the invalid Email ID: "
			...
			assertTrue(
					...
					CommonFun.isElementPresent(
							driver,
							By.xpath(XpathObjectRepo.forgotPasswordInvalidEmailError_XPATH)));
