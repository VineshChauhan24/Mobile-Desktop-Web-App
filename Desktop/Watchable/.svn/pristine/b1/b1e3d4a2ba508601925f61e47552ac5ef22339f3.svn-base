...
/**
 * Class Name: SearchWithChannelName Description: This test script verify search
 * functionality by searching with channel name. Author: Manoj
 * **/

public class SearchWithChannelName extends BaseTest {

	AssertionRepoFunctions assertionFunction = new AssertionRepoFunctions();

	@Test
	public void testSearchWithChannelName() throws Exception {

		try {

			log.info("Script: SearchWithChannelName");
			log.info("*****************************");
