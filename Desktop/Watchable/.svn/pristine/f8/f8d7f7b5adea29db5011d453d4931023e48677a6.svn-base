 ...
 * verifies videos are displayed in featured Playlists section 
 * Author: Manoj
 * **/
		...
		try {
			...
			if (videoCount > 0) {
				...
				for (int i = 1; i <= videoCount; i++) {
					...
					/*
					 * //Video details is removed from Play list
					 * log.info("   Video detail: " + driver.findElement(
					 * By.xpath
					 * (XpathObjectRepo.playlistsSelectedVideoDetail_XPATH))
					 * .getText()); 
					 */
					Thread.sleep(sleepTime);
