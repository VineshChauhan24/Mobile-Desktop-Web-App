...
/**
 * Class Name: VerifyEmailSharingSendWithInvalidEmails Description: This test
 * script verifies clicking on send button from email sharing pop up window by
 * entering invalid from and to email address displaying error message for both
 * fields. 
 * Author: Manoj
 * **/

public class VerifyEmailSharingSendWithInvalidEmails extends BaseTest {
	@Test
	public void testVerifyEmailSharingSendWithInvalidEmails() throws Exception {

		try {

			// Test script
			log.info("Script: VerifyEmailSharingSendWithInvalidEmails");
			log.info("************************************************");
