package comcast.test.app.testCases.videoManagement.genres.channels.NonProfit;
...
/**
 * Class Name: VerifyNonProfitChannels Description: This test case validates
 * whether channels are displayed in Non Profit Category CHANNELS PAGE in Home
 * page by with/without logging into Watchable application.
 * **/

public class VerifyNonProfitChannels extends BaseTest {
	...
	@Test
	public void testVerifyNonProfitChannels() throws Exception {

		Map<String, List<VideoDetails>> videoDetails = RestAPIServices
				.GenreCategoriesDetail(UILablesRepo.NONPROFIT);
				...
				for (int category = 1; category <= noOfCategoriesDisplayed; category++) {
					if (noOfCategoriesDisplayed <= 8) {
						String getCategoryTitle = driver
								...
								.getText();
						if (getCategoryTitle
								.equalsIgnoreCase(UILablesRepo.NONPROFIT)) {
							categoryFound = true;
