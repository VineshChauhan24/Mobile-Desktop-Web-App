...
/**
 * Class Name: VerifyVideoPageTitleNavigatingFromPlayList Description: This test
 * script verifies the video page title after navigating video page from play
 * list. Author: Manoj
 * **/

public class VerifyVideoPageTitleNavigatingFromPlayList extends BaseTest {
	AssertionRepoFunctions assertionFunction = new AssertionRepoFunctions();

	@Test
	public void testVerifyVideoPageTitleNavigatingFromPlayList()
			throws Exception {

		try {

			log.info("Script: VerifyVideoPageTitleNavigatingFromPlayList");
			log.info("*************************************************");
