...
/**
 * Class Name: RegisterToWatchableWithoutEnteringPassword Description: This test
 * case try registers to Watchable application without entering password.
 * Author: Manoj
 * **/

public class RegisterToWatchableWithoutEnteringPassword extends BaseTest {

	AssertionRepoFunctions assertionFunction = new AssertionRepoFunctions();

	@Test
	public void testRegisterToWatchableWithoutEnteringPassword()
			throws Exception {

		try {

			log.info("Script: RegisterToWatchableWithoutEnteringPassword");
			log.info("**************************************************");
			...
			// click on SIGN UP button without entering password.
