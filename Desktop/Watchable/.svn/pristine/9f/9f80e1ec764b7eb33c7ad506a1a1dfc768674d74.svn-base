...
/**
 * Class Name: LoginToWatchableWithValidUserName Description: This test case
 * try to login to Watchable application with an Valid UserName and Password.
 * Author: Manoj
 * **/

public class LoginToWatchableWithValidUserName extends BaseTest {

	AssertionRepoFunctions assertionFunction = new AssertionRepoFunctions();

	@Test
	public void testLoginToWatchableWithValidUserName() throws Exception {

		try {

			log.info("Script: LoginToWatchableWithValidUserName");
			log.info("********************************************");
