package comcast.test.app.testCases.videoManagement.genres.channels.NewsAndPolitics;
...
/**
 * Class Name: VerifyNewsAndPoliticsChannels Description: This test case
 * validates whether channels are displayed in News And Politics Category
 * CHANNELS PAGE in Home page by with/without logging into Watchable
 * application.
 * **/

public class VerifyNewsChannels extends BaseTest {
	...
	@Test
	public void testVerifyNewsChannels() throws Exception {
