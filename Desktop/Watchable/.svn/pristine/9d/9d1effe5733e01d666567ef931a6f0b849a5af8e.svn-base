...
/**
 * Class Name: VerifyClickingOnHomeFooterLinkFromShowPageNavigatesHomePage: This
 * test case click on home footer from show page, navigating back to Home page.
 * Author: Manoj
 * **/

public class VerifyClickingOnHomeFooterLinkFromShowPageNavigatesHomePage extends
		BaseTest {
	...
	@Test
	public void testVerifyClickingOnHomeFooterLinkFromShowPageNavigatesHomePage()
			throws Exception {

		try {

			log.info("Script: VerifyClickingOnHomeFooterLinkFromShowPageNavigatesHomePage");
			log.info("*******************************************************************");
			...
			AssertionRepoFunctions.assertWatchableTitle();
			log.info("Successfully Navigated to Home page after clicking on Home link from show page");
