...
/**
 * Class Name: VerifyPlayListSharingSendWithInvalidToEmail Description: This
 * test script verifies clicking on send button from play list sharing pop up
 * window by entering invalid to email address displaying error message for to
 * email fields. 
 * Author: Manoj
 * **/

public class VerifyPlayListSharingSendWithInvalidToEmail extends BaseTest {
	AssertionRepoFunctions assertionFunction = new AssertionRepoFunctions();

	@Test
	public void testVerifyPlayListSharingSendWithInvalidToEmail()
			throws Exception {

		try {

			log.info("Script: VerifyPlayListSharingSendWithInvalidToEmail");
			log.info("****************************************************");
