...
/**
 * Class Name: VerifyChannelNameOfCurrentPlayingVideo Description:This test
 * script verifies display of Channel name of currently playing video in video
 * page. Author: Manoj
 * **/

public class VerifyChannelNameOfCurrentPlayingVideo extends BaseTest {
	...
	@Test
	public void testVerifyChannelNameOfCurrentPlayingVideo() throws Exception {

		try {

			// Test script
			log.info("Script: VerifyChannelNameOfCurrentPlayingVideo");
			log.info("**********************************************");
