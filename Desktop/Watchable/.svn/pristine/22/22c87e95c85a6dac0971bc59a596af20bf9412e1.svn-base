...
/**
 * Class Name: SearchWithProviderName Description: This test script verify
 * search functionality by searching with provider name. Author: Manoj
 * **/

public class SearchWithProviderName extends BaseTest {

	AssertionRepoFunctions assertionFunction = new AssertionRepoFunctions();

	@Test
	public void testSearchWithProviderName() throws Exception {

		try {

			log.info("Script: SearchWithProviderName");
			log.info("******************************");
