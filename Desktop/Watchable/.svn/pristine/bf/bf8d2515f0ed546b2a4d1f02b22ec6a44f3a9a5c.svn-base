...
/**
 * Class Name: SearchWithVideoId Description: This test script verify search
 * functionality by searching with video ID. Author: Manoj
 * **/

public class SearchWithVideoId extends BaseTest {

	AssertionRepoFunctions assertionFunction = new AssertionRepoFunctions();

	@Test
	public void testSearchWithVideoId() throws Exception {

		try {

			log.info("Script: SearchWithVideoId");
			log.info("*************************");
