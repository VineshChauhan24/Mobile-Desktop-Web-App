...
/**
 * Class Name: SearchWithSpecialCharacters Description: TThis test script verify
 * search functionality by searching with string contains Special Characters as search key.
 * Author: Manoj
 * **/

public class SearchWithSpecialCharacters extends BaseTest {
	...
	public void testSearchWithSpecialCharacters() throws Exception {
		...
		try {
			...
			log.info("Script: SearchWithSpecialCharacters");
			log.info("****************************");
			...
			searchFun
					.enterSearchStringPressEnterKey(UILablesRepo.SEARCH_SPL_KEY);
