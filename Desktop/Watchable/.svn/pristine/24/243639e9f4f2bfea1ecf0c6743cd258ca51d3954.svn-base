package comcast.test.app.testCases.videoManagement.genres.channels.TravelAndEvents;
...
/**
 * Class Name: VerifyTravelsAndEventsChannels Description: This test case
 * validates whether channels are displayed in Travels And Events Category
 * CHANNELS PAGE in Home page by with/without logging into Watchable
 * application.
 * **/

public class VerifyTravelsAndEventsChannels extends BaseTest {
	...
	@Test
	public void testVerifyTravelsAndEventsChannels() throws Exception {

		Map<String, List<VideoDetails>> videoDetails = RestAPIServices
				.GenreCategoriesDetail(UILablesRepo.TRAVELSANDEVENTS);
				...
				for (int category = 1; category <= noOfCategoriesDisplayed; category++) {
					...
					if (noOfCategoriesDisplayed <= 8) {
						String getCategoryTitle = driver
								...
								.getText();
						if (getCategoryTitle
								.equalsIgnoreCase(UILablesRepo.TRAVELSANDEVENTS)) {
							categoryFound = true;
