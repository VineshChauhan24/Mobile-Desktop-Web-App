...
/**
 * Class Name: SearchWithVideoName Description: This test script verify search
 * functionality by searching with video name. Author: Manoj
 * **/

public class SearchWithVideoName extends BaseTest {

	AssertionRepoFunctions assertionFunction = new AssertionRepoFunctions();

	@Test
	public void testSearchWithVideoName() throws Exception {

		try {

			log.info("Script: SearchWithVideoName");
			log.info("***************************");
			...
			searchFun
					.enterSearchStringPressEnterKey(UILablesRepo.SEARCH_VIDEO_NAME);
