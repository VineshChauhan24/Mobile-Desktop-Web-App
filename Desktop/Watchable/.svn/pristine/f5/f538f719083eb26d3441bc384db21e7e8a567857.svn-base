...
/**
 * Class Name: VerifyTermsAndConditionsPageAccept Description: This test case
 * verifies functionality of Accept button in Terms And Conditions page. 
 * Author: * Manoj
 * **/

public class VerifyTermsAndConditionsPageAccept extends BaseTest {

	AssertionRepoFunctions assertionFunction = new AssertionRepoFunctions();

	@Test
	public void testVerifyTermsAndConditionsPageAccept() throws Exception {

		try {

			log.info("Script: VerifyTermsAndConditionsPageAccept");
			log.info("******************************************");
			...
			// Click on Accept Button from Terms & Conditions Page

			SignUpFun.clickOntermsAndConditionsFormAcceptButton();
			...
			assertTrue(
					"Terms Conditions Check is not selected after clicking on Accept button from Terms & Conditions Page",
					driver.findElement(
							By.xpath(XpathObjectRepo.signUpFormTermsCheckBox_XPATH))
							.isSelected());
			log.info("Terms Conditions Check is selected after clicking on Accept button from Terms & Conditions Page");
