...
/**
 * Class Name: VerifyPlayListEmailSharringFromEmailContent Description: This
 * test script verifies the from email text field im email sharing of playlist
 * windows is pre-populated with logged in user email address.. 
 * Author: Manoj
 * **/

public class VerifyPlayListEmailSharringFromEmailContent extends BaseTest {
	AssertionRepoFunctions assertionFunction = new AssertionRepoFunctions();

	@Test
	public void testVerifyPlayListEmailSharringFromEmailContent()
			throws Exception {

		try {

			log.info("Script: VerifyPlayListEmailSharringFromEmailContent");
			log.info("******************************************************");
