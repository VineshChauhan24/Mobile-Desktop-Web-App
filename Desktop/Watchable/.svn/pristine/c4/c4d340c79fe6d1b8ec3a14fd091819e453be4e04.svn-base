...
/**
 * Class Name: VerifyNavigatingToVideoPageClickingOnPlayListDescFromPlayList
 * Description: This test script verifies navigating video page after clicking
 * on play list description from play list. list. Author: Manoj
 * **/

public class VerifyNavigatingToVideoPageClickingOnPlayListDescFromPlayList
		extends BaseTest {
	AssertionRepoFunctions assertionFunction = new AssertionRepoFunctions();

	@Test
	public void testVerifyNavigatingToVideoPageClickingOnPlayListDescFromPlayList()
			throws Exception {

		try {

			log.info("Script: VerifyNavigatingToVideoPageClickingOnPlayListDescFromPlayList");
			log.info("***********************************************************************");
			...
			if (playListCount > 0) {
				...
				// Click on play list description
				PlayListsFun.clickOnPlayListDescFromPlayList();
