...
/**
 * Class Name: LoginToWatchableUsingSQLKeyWords Description: This test case try
 * to login to Gazeebo application by entering user name/email as SQL keywords and
...
public class LoginToWatchableUsingSQLKeyWords extends BaseTest {
	...
	public void testLoginToWatchableUsingSQLKeyWords() throws Exception {
		...
		try {
			...
			log.info("Script: LoginToWatchableUsingSQLKeyWords");
			log.info("********************************************");
			...
			log.info("Login to watchable application failed user name as SQL keywords and valid password");
