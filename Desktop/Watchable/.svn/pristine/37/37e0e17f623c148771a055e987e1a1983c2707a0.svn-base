...
/**
 * Class Name: RegToWatchableByEnteringExistingUserName Description: This test
 * case is to validated registration by providing existing user name 
 * Author: Manoj
 * **/

public class RegToWatchableByEnteringExistingUserName extends BaseTest {

	AssertionRepoFunctions assertionFunction = new AssertionRepoFunctions();

	@Test
	public void testRegToWatchableByEnteringExistingUserName() throws Exception {

		try {

			log.info("Script: RegToWatchableByEnteringExistingUserName");
			log.info("***********************************************");
			...
			SignUpFun.enterSignUpDetails(driver, UILablesRepo.INVALIDUSERNAME,
