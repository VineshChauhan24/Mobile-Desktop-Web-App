...
/**
 * Class Name: LoginToWatchableWithValidCredentials Description: This test case
 * try to login to Watchable application with an Valid email and Password.
 * Author: Manoj
 * **/
...
public class LoginToWatchableWithValidCredentials extends BaseTest {
	...
	public void testLoginToWatchableWithValidCredentials() throws Exception {
		...
		try {
			...
			log.info("Script: LoginToWatchableWithValidCredentials");
			log.info("********************************************");
